calcularValorTotal = function () {
    ...
    let montoBaseIVA = valorSubtotal - valorDescuento;
    valorIVA = calcularIVA(montoBaseIVA);
    ...
    let total = calcularTotal(valorSubtotal, valorDescuento, valorIVA);
    ...
    mostrarTexto("lblResumen", "Total: $" + total.toFixed(2));
    /*
        Ejemplo: 
...
limpiar = function () {
    ...
    document.getElementById("lblValorIVA").innerHTML = "0.0";
    document.getElementById("lblTotal").innerText = "0.0";
    document.getElementById("lblResumen").innerText = "0.0";
